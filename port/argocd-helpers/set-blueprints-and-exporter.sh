...
# export CUSTOM_BP_PATH="https://raw.githubusercontent.com/tkhalane/mtnx-demo/main/port/argocd-helpers/mini-argo-blueprints.json"
...
# export CONFIG_YAML_URL="https://raw.githubusercontent.com/tkhalane/mtnx-demo/main/port/argocd-helpers/mini-exporter-config.yaml"
